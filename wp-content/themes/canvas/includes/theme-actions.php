...
add_action( 'woo_nav_inside','woo_nav_search', 20 );
...
function woo_custom_styling() {
	...
	if ( isset( $woo_options['woo_style_disable'] ) && $woo_options['woo_style_disable'] != 'true' ) {} else {
		...
		if ($link)
			$output .= 'a:link, a:visited, #loopedSlider a.flex-prev:hover, #loopedSlider a.flex-next:hover {color:'.$link.'} .quantity .plus, .quantity .minus {background-color: ' . $link . ';}' . "\n";
		if ($hover)
			$output .= 'a:hover, .post-more a:hover, .post-meta a:hover, .post p.tags a:hover {color:'.$hover.'}' . "\n";
		if ($button)
			$output .= 'body #wrapper #content .button, body #wrapper #content .button:visited, body #wrapper #content .reply a, body #wrapper #content #respond .form-submit input#submit, input[type=submit], #navigation ul.cart .button {border: none; background:'.$button.'}' . "\n";
		if ($button_hover)
			$output .= 'body #wrapper #content .button:hover, body #wrapper #content .reply a:hover, body #wrapper #content #respond .form-submit input#submit:hover, input[type=submit]:hover, #navigation ul.cart .button:hover {border: none; background:'.$button_hover.'}' . "\n";
		...
		if ( $header_padding_right <> '' )
			$output .= '.header-widget {padding-right:'.$header_padding_right.'px;}'. "\n";
		if ( $font_logo )
		...
		$nav_margin_top = $woo_options['woo_nav_margin_top'];
		$nav_margin_bottom = $woo_options['woo_nav_margin_bottom'];
		...
		if ( $nav_font )
			$output .= 'ul.nav li a, #navigation ul.rss a, #navigation .cart-contents, #navigation .cart-contents #navigation ul.rss, #navigation ul.cart .cart_list a, #navigation ul.nav-search, #navigation ul.nav-search a { ' . woo_generate_font_css( $nav_font, 1.2 ) . ' } #navigation ul.rss li a:before, #navigation ul.nav-search .searchform .icon-search:before { color:' . $nav_font['color'] . ';}' . "\n";
		if ( $nav_hover )
			$output .= '#navigation ul.nav > li a:hover, #navigation ul.nav > li:hover a, #navigation ul.nav li ul li a, #navigation ul.cart > li:hover > a, #navigation ul.cart > li > ul > div, #navigation ul.cart > li > ul > div p, #navigation ul.cart > li > ul span, #navigation ul.cart .cart_list a, #navigation ul.nav li.current_page_item a, #navigation ul.nav li.current_page_parent a, #navigation ul.nav li.current-menu-ancestor a, #navigation ul.nav li.current-cat a, #navigation ul.nav li.current-menu-item a { color:'.$nav_hover.'!important; }' . "\n";
		if ( $nav_hover_bg )
			$output .= '#navigation ul.nav > li a:hover, #navigation ul.nav > li:hover, #navigation ul.nav li ul, #navigation ul.cart > li:hover, #navigation ul.cart > li > ul > div, #navigation ul.nav li.current_page_item a, #navigation ul.nav li.current_page_parent a, #navigation ul.nav li.current-menu-ancestor a, #navigation ul.nav li.current-cat a, #navigation ul.nav li.current-menu-item a{background-color:'.$nav_hover_bg.'!important}' . "\n";

		if ( $nav_dropdown_border && $nav_dropdown_border["width"] >= 0 ) {
			$output .= '#navigation ul.nav li ul, #navigation ul.cart > li > ul > div  { border: '.$nav_dropdown_border["width"].'px '.$nav_dropdown_border["style"].' '.$nav_dropdown_border["color"].'; }' . "\n";
		...
		if ( $nav_margin_top <> '' || $nav_margin_bottom <> '' )
			$navigation_css .= 'margin-top:'.$nav_margin_top.'px;margin-bottom:'.$nav_margin_bottom.'px;';
		...
		if ( $slider_magazine_font_title ) {
			...
			$output .= '.wooslider-theme-magazine .slide-title a { ' . woo_generate_font_css( $slider_magazine_font_title ) . ' }'. "\n";
		}
		if ( $slider_magazine_font_excerpt ) {
			...
			// WooSlider Integration
			$output .= '.wooslider-theme-magazine .slide-content p, .wooslider-theme-magazine .slide-excerpt p { ' . woo_generate_font_css( $slider_magazine_font_excerpt, 1.5 ) . ' }'. "\n";

		}
		if ( $magazine_grid_font_post_title ) {
			$output .= '.magazine .block .post .title {' . woo_generate_font_css( $magazine_grid_font_post_title, 1.2 ) . ' }'. "\n";
		}
		...
		$slider_biz_overlay = $woo_options['woo_slider_biz_overlay'];

		if ( $slider_biz_font_title ) {
			$output .= '#loopedSlider.business-slider .content h2 { ' . woo_generate_font_css( $slider_biz_font_title ) . ' }'. "\n";
			$output .= '#loopedSlider.business-slider .content h2.title a { ' . woo_generate_font_css( $slider_biz_font_title ) . ' }'. "\n";
			// WooSlider Integration
			$output .= '.wooslider-theme-business .has-featured-image .slide-title { ' . woo_generate_font_css( $slider_biz_font_title ) . ' }'. "\n";
			$output .= '.wooslider-theme-business .has-featured-image .slide-title a { ' . woo_generate_font_css( $slider_biz_font_title ) . ' }'. "\n";
		}
		if ( $slider_biz_font_excerpt ) {
			$output .= '#wrapper #loopedSlider.business-slider .content p { ' . woo_generate_font_css( $slider_biz_font_excerpt, 1.5 ) . ' }'. "\n";
			// WooSlider Integration
			$output .= '.wooslider-theme-business .has-featured-image .slide-content p { ' . woo_generate_font_css( $slider_biz_font_excerpt, 1.5 ) . ' }'. "\n";
			$output .= '.wooslider-theme-business .has-featured-image .slide-excerpt p { ' . woo_generate_font_css( $slider_biz_font_excerpt, 1.5 ) . ' }'. "\n";

		}

		// Slider overlay
		if ( $slider_biz_overlay == 'left' || $slider_biz_overlay == 'right' || $slider_biz_overlay == 'center' || $slider_biz_overlay == 'full' || $slider_biz_overlay == 'none' ) {
			$output .= '@media only screen and (min-width:768px) {' . "\n";
			if ( $slider_biz_overlay && $slider_biz_overlay == 'left' )
			...
			if ( $slider_biz_overlay && $slider_biz_overlay == 'right' )
...
function woo_add_full_width_class ( $classes ) {
	...
	if ( 'true' == $settings['header_full_width'] || 'true' == $settings['footer_full_width'] || 'true' == $settings['slider_biz_full'] ) {
		$classes[] = 'full-width';
		...
		if ( 'true' == $settings['slider_biz_full'] ) {
			$classes[] = 'full-slider';
		}
	}
