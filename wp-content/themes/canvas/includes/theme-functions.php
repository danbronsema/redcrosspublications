	...
	function woo_pagenav( $custom_query = '' ) {
		...
		?>
            <div class="nav-entries">
                <?php next_posts_link( '<span class="nav-prev fl"><i class="icon-angle-' . esc_attr( $left_class ) . '"></i> '. __( 'Older posts', 'woothemes' ) . '</span>', $max_pages ); ?>
                <?php previous_posts_link( '<span class="nav-next fr">'. __( 'Newer posts', 'woothemes' ) . ' <i class="icon-angle-' . esc_attr( $right_class ) . '"></i></span>' ); ?>
                <div class="fix"></div>
            </div>
		<?php
			} // End IF Statement
	...
	function woo_postnav() {
		...
		?>
	        <div class="post-entries">
	            <div class="nav-prev fl"><?php previous_post_link( '%link', '<i class="icon-angle-' . esc_attr( $left_class ) . '"></i> %title' ) ?></div>
	            <div class="nav-next fr"><?php next_post_link( '%link', '%title <i class="icon-angle-' . esc_attr( $right_class ) . '"></i>' ) ?></div>
	            <div class="fix"></div>
	        </div>
...
if ( ! function_exists( 'woo_search_filter' ) ) {

function woo_search_filter( $query ) {

	global $woo_options;

	if ( isset( $woo_options['woo_header_search_scope'] ) && $woo_options['woo_header_search_scope'] != 'products' && is_woocommerce_activated() ) {
